...
Next
command = "java -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,address=4001,server=y,suspend=y -Dlog4j.configuration=" & WScript.Arguments(0) & " -Xmx256M -classpath """ & classpath & """" & command
